            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form id="addForm">
                        ...
                        <div>
                            <%--<body>--%>
                                <input type="radio" name="icon" value="glyphicon glyphicon-th-list" >图标一</input>
                                <input type="radio" name="icon" value="glyphicon glyphicon-dashboard" >图标二</input>
                                <input type="radio" name="icon" value="glyphicon glyphicon glyphicon-tasks" >图标三</input>
                                <input type="radio" name="icon" value="glyphicon glyphicon-user" >图标四</input>
                            <%--</body>--%>
                        </div>
...
<script type="text/javascript">
    ...
    $("#addBtn").click(function(){
        ...
        $.ajax({
            ...
            url : "${APP_PATH}/permission/doAdd.action",
            beforeSend : function() {
