                    ...
                    <div class="table-responsive">
                        ...
                        <c:forEach items="${roleList}" var="role" varStatus="status">
                            ...
                            <tr>
                                ...
                                <td>${role.name}</td>
                                <td>
                                    <button type="button" onclick="window.location.href='${APP_PATH}/role/assignPermission.action?roleid=${role.id}'" class="btn btn-success btn-xs"><i class=" glyphicon glyphicon-check"></i></button>
