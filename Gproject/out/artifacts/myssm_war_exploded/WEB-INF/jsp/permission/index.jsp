...
<script src="s${APP_PATH}/cript/docs.min.js"></script>
        ...
        view : {
            ...
            addHoverDom: function(treeId, treeNode){   //设置自定义按钮组,在节点后面悬停显示增删改按钮组.
                ...
                if ( treeNode.level == 0 ) { //根节点
                    s += '<a class="btn btn-info dropdown-toggle btn-xs" style="margin-left:10px;padding-top:0px;" href="#" onclick="window.location.href=\'${APP_PATH}/permission/toAdd.action?id='+treeNode.id+'\'" >&nbsp;&nbsp;<i class="fa fa-fw fa-plus rbg "></i></a>';
                } else if ( treeNode.level == 1 ) { //分支节点
                    s += '<a class="btn btn-info dropdown-toggle btn-xs" style="margin-left:10px;padding-top:0px;"  href="#" onclick="window.location.href=\'${APP_PATH}/permission/toUpdate.action?id='+treeNode.id+'\'" title="修改权限信息">&nbsp;&nbsp;<i class="fa fa-fw fa-edit rbg "></i></a>';
...
//    ];
    function loadData() {
        $.ajax({
            ...
            url:"${APP_PATH}/permission/loadData.action",
            type:"post",
    ...
    function deletePermission(id,name){
        ...
        layer.confirm("确定要删除["+name+"]许可吗?",  {icon: 3, title:'提示'}, function(cindex){
            ...
            $.ajax({
                ...
                url:"${APP_PATH}/permission/deletePermission.action",
                data : {
                    "id" : id
                },
                type:"post",
