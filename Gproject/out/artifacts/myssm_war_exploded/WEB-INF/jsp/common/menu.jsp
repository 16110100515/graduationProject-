...
<ul style="padding-left:0px;" class="list-group">
    ...
    <c:forEach items="${sessionScope.permissionRoot.children }" var="permission">
        <c:if test="${empty permission.children}">
            <li class="list-group-item tree-closed" >
                <a href="${APP_PATH }/dispatcher/${permission.url }"><i class="${permission.icon}"></i> ${permission.name }</a>
            </li>
        </c:if>
    ...
    <%--<li class="list-group-item">--%>
        ...
        <%--<ul style="margin-top:10px;">--%>
            <%--<li style="height:30px;">--%>
                <%--<a href="${APP_PATH}/user/toIndex.action" ><i class="glyphicon glyphicon-user"></i> 用户维护</a>--%>
            <%--</li>--%>
            <%--<li style="height:30px;">--%>
                <%--<a href="${APP_PATH }/role/index.action"><i class="glyphicon glyphicon-king"></i> 角色维护</a>--%>
            <%--</li>--%>
            <%--<li style="height:30px;">--%>
                <%--<a href="${APP_PATH}/permission/index.action"><i class="glyphicon glyphicon-lock"></i> 许可维护</a>--%>
            <%--</li>--%>
        <%--</ul>--%>
    <%--</li>--%>
    <%--<li class="list-group-item tree-closed">--%>
